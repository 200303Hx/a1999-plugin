    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/夜色亵渎者.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/好奇心宝贝.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/必要的记录.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/掌声如雷鸣.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/第二次生命.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/美丽新世界.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/跳房子游戏.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/午后小憩.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/心驰神往.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/无束无拘.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/明日亦然.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/示我以真.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/笑语欢声.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/自由的心.png`
    )
    return false
  }
    ...
    e.sendImage(
      `${process
        ...
        .replace(
          /\\/g,
          '/'
        )}/plugins/alemon-plugin-1999/resources/assets/img/图鉴/心相/远大前程.png`
    )
    return false
  }
