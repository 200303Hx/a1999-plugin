...
const folderPaths = [
  path.resolve(__dirname, '../../resources/assets/img/模拟抽卡/6-lim2'),
  path.resolve(__dirname, '../../resources/assets/img/模拟抽卡/5-lim2'),
...
const dbFolderPath = path.resolve(__dirname, '../../db/模拟抽卡/drawCountMap-lim2.json')
const drawCountMapPath = path.resolve(__dirname, '../../db/模拟抽卡/drawCountMap-lim2.json')
// 背景图的宽度和高度
