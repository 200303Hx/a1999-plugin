...
class show extends plugin {
    ...
    async 抽卡帮助(e) {
        e.reply(getPathBuffer(`/application/alemon-plugin-1999/resources/assets/img/help/抽卡帮助.png`));
        return false;
    }
    async 听力笔记(e) {
    ...
    async 抽卡分析(e) {
        e.reply(getPathBuffer(`/application/alemon-plugin-1999/resources/assets/img/help/抽卡分析.jpg`));
        return false;
    }
}
